...
export default function Header({ showSearch = true }: HeaderProps) {
  ...
  return (
    <>
      <header className="sticky top-0 z-50 bg-[#f0f3f8] border-b border-[#dde3ee]">
          ...
          <div className="flex items-center gap-0.5">
            ...
            {showSearch && (
              <Link
                ...
                className="flex min-h-[44px] min-w-[44px] items-center justify-center rounded-full text-[#1a2235]/60 transition hover:bg-black/8 hover:text-[#1a2235]"
              >
                <SearchIcon />
              </Link>
            )}
